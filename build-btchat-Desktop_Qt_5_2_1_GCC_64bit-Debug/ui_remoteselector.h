...
public:
    ...
    {
        RemoteSelector->setWindowTitle(QApplication::translate("RemoteSelector", "Available chat services", 0));
        status->setText(QApplication::translate("RemoteSelector", "Scanning...", 0));
        cancelButton->setText(QApplication::translate("RemoteSelector", "Cancel", 0));
    } // retranslateUi
