...
#include "../btchat/remoteselector.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RemoteSelector_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 139, 23)
    ...
    "QListWidgetItem*\0item\0on_cancelButton_clicked\0"
};
...
const QMetaObject RemoteSelector::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RemoteSelector.data,
      qt_meta_data_RemoteSelector,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RemoteSelector.stringdata))
        return static_cast<void*>(const_cast< RemoteSelector*>(this));
