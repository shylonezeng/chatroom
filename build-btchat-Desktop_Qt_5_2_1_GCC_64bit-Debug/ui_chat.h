...
public:
    ...
    {
        Chat->setWindowTitle(QApplication::translate("Chat", "Bluetooth Chat", 0));
        localAdapterBox->setTitle(QApplication::translate("Chat", "Local Bluetooth Adapter", 0));
        firstAdapter->setText(QApplication::translate("Chat", "Default", 0));
        secondAdapter->setText(QString());
        sendButton->setText(QApplication::translate("Chat", "Send", 0));
        connectButton->setText(QApplication::translate("Chat", "Connect", 0));
        quitButton->setText(QApplication::translate("Chat", "Quit", 0));
    } // retranslateUi
